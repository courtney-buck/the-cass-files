...
- **`governance/`** — Decision rights, approval frameworks, and the rules that keep agents honest
- **`architecture/`** — How the agent network is structured and why
- **`skills/`** — Skill templates and examples for OpenClaw agents
- **`configs/`** — Configuration examples and patterns
- **`logs/`** — Sanitized build logs and decision records
